...
GameServer.prototype.send = function (userId, msg) {
...
GameServer.prototype.broadcast = function (msg) {
  msg = utils.encode(msg);
...
GameServer.prototype.multicast = function (userIds, msg) {
  msg = utils.encode(msg);
...
GameServer.prototype.attachPub = function (pub) {
  this.pub = pub;
}
